...
;; Access functions for the KDED KIO daemon from Tramp.  Tested?
;; KIO allows us to use various KIO services through their respective
;; API's. Most of them are useful for us while others not so much.

;; All actions to mount a remote location, and to retrieve mount
;; information, are performed by D-Bus messages.  If KIO-Fuse is supported
;; File operations themselves are performed via the mounted filesystem in
;; /run/user/<id>/kio-fuse-<6-char-random-str>
...
;; The user option `tramp-kio-methods' contains the list of supported
...
;; account in KDE Online Accounts, with enabled "Files" service.
...
;; See also /usr/lib64/qt6/plugins/kf6/kio/
;; The exact path depends on Qt version and distribution.

;; Note that all other connection methods are not tested, beside the
;; ones offered for customization in `tramp-kio-methods'.  If you
;; request an additional connection method to be supported, please
;; drop me a note.
;; Some of these methods might be intended to be used this way at all.
;; KIO is the io backend of many KDE applications only some of them
;; are supposed to be used directly.

;; for reference check:
;; https://invent.kde.org/plasma/kde-cli-tools/-/blob/master/kioclient/kioclient.cpp
...
;; services, the user option `tramp-kio-zeroconf-domain' can be set
;; accordingly.
...
;; ;;;###tramp-autoload
;; (defconst tramp-kaccounts-methods '("gdrive" "nextcloud")
...
;; FIXME: There should be an equivalent in KDE's KIO to these
;;;###tramp-autoload
...
(defcustom tramp-kio-zeroconf-domain "local"
...
(defconst tramp-kded-path-tramp (concat dbus-path-emacs "/Tramp-kio")
  "The preceding object path for own objects.")

(defconst tramp-kded-service-daemon "org.kde.kded6"
  "The well known name of the KDED daemon.")
;; FIXME: find kded equivalent, kio-fuse?
(defconst tramp-kded-path-mounttracker "/org/gtk/vfs/mounttracker"
  "The object path of the GVFS daemon.")
;; FIXME: find kded equivalent, kio-fuse?
(defconst tramp-kded-interface-mounttracker "org.gtk.vfs.MountTracker"
  "The mount tracking interface in the KDED daemon.")

;; Introspection data exist since KDED 1.14.  If there are no such
;; data, we expect an earlier interface.
(defconst tramp-kded-methods-mounttracker
  (and tramp-kded-enabled
       (dbus-introspect-get-method-names
	:session tramp-kded-service-daemon tramp-kded-path-mounttracker
	tramp-kded-interface-mounttracker))
  "The list of supported methods of the mount tracking interface.")

(defconst tramp-kded-listmountableinfo
  (if (member "ListMountableInfo" tramp-kded-methods-mounttracker)
      "ListMountableInfo"
    "listMountableInfo")
  "The name of the \"listMountableInfo\" method.
It has been changed in KDED 1.14.")

(defconst tramp-kded-listmounttypes
  (if (member "ListMountTypes" tramp-kded-methods-mounttracker)
      "ListMountTypes"
    "listMountTypes")
  "The name of the \"listMountTypes\" method.
It has been changed in KDED 1.14.")

(defconst tramp-kded-mounttypes
  (and tramp-kded-enabled
       (dbus-call-method
	:session tramp-kded-service-daemon tramp-kded-path-mounttracker
	tramp-kded-interface-mounttracker tramp-kded-listmounttypes))
  "The list of supported mount types of the mount tracking interface.")

(defconst tramp-kded-listmounts
  (if (member "ListMounts" tramp-kded-methods-mounttracker)
      "ListMounts"
    "listMounts")
  "The name of the \"listMounts\" method.
It has been changed in KDED 1.14.")

(defconst tramp-kded-mountlocation
  (if (member "MountLocation" tramp-kded-methods-mounttracker)
      "MountLocation"
    "mountLocation")
  "The name of the \"mountLocation\" method.
It has been changed in KDED 1.14.")

(defconst tramp-kded-mountlocation-signature
  (and tramp-kded-enabled
       (dbus-introspect-get-signature
	:session tramp-kded-service-daemon tramp-kded-path-mounttracker
	tramp-kded-interface-mounttracker tramp-kded-mountlocation))
...
;; FIXME: find kded equivalent, kio-fuse?
(defconst tramp-kded-interface-mountoperation "org.gtk.vfs.MountOperation"
...
(defconst tramp-kded-password-need-password 1
  "Operation requires a password.")

(defconst tramp-kded-password-need-username 2
  "Operation requires a username.")

(defconst tramp-kded-password-need-domain 4
  "Operation requires a domain.")

(defconst tramp-kded-password-saving-supported 8
  "Operation supports saving settings.")

(defconst tramp-kded-password-anonymous-supported 16
  "Operation supports anonymous users.")

;; Since: 2.58
(defconst tramp-kded-password-tcrypt 32
...
;;;###tramp-autoload
(defconst tramp-kded-service-afc-volumemonitor "org.gtk.vfs.AfcVolumeMonitor"
  "The well known name of the AFC volume monitor.")

;; This one is not needed yet.
(defconst tramp-kded-service-goa-volumemonitor "org.gtk.vfs.GoaVolumeMonitor"
  "The well known name of the GOA volume monitor.")

;;;###tramp-autoload
(defconst tramp-kded-service-gphoto2-volumemonitor
  "org.gtk.vfs.GPhoto2VolumeMonitor"
  "The well known name of the GPhoto2 volume monitor.")

;;;###tramp-autoload
(defconst tramp-kded-service-mtp-volumemonitor "org.gtk.vfs.MTPVolumeMonitor"
  "The well known name of the MTP volume monitor.")

(defconst tramp-kded-path-remotevolumemonitor
  "/org/gtk/Private/RemoteVolumeMonitor"
  "The object path of the remote volume monitor.")

(defconst tramp-kded-interface-remotevolumemonitor
  "org.gtk.Private.RemoteVolumeMonitor"
...
;; "kded-<command>" utilities have been deprecated in KDED 1.31.1.  We
;; must use "gio <command>" tool instead.
(defconst tramp-kded-gio-mapping
  '(("kded-copy" . "copy")
    ("gvfs-info" . "info")
    ("gvfs-ls" . "list")
    ("gvfs-mkdir" . "mkdir")
